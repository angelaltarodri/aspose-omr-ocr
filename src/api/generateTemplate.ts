...
export class GenerateTemplate {
    ...
    async cancelGenerateTemplate(id : string) {
        let postBody = null;
    
        // create path and map variables
        let path : string = "GenerateTemplate/CancelGenerateTemplate".replace("{format}", "json");
      ...
      async getGenerateTemplate  (id: string) : Promise<OMRResponse> {
        let postBody = null;
    
        // create path and map variables
        let path:string = "GenerateTemplate/GetGenerateTemplate".replace("{format}", "json");
      ...
      async postGenerateTemplate( body: OmrGenerateTask) : Promise<string> {
        let postBody = JSON.stringify(body);
        // verify required params are set
    
        // create path and map variables
        let path : string = "GenerateTemplate/PostGenerateTemplate".replace("{format}", "json");
