...
var _OCRError = _interopRequireDefault(require("./OCRError"));
var _OCRResult = _interopRequireDefault(require("./OCRResult"));
var _OCRTaskStatus = _interopRequireDefault(require("./OCRTaskStatus"));
var _ResponseStatusCode = _interopRequireDefault(require("./ResponseStatusCode"));
 ...
 * @version 5.0
 */
var OCRResponse = /*#__PURE__*/function () {
  /**
  ...
  function OCRResponse() {
    _classCallCheck(this, OCRResponse);
  ...
  _createClass(OCRResponse, null, [{
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('responseStatusCode')) {
          obj['responseStatusCode'] = _ResponseStatusCode["default"].constructFromObject(data['responseStatusCode']);
        }
        if (data.hasOwnProperty('taskStatus')) {
          obj['taskStatus'] = _OCRTaskStatus["default"].constructFromObject(data['taskStatus']);
        }
        if (data.hasOwnProperty('results')) {
          obj['results'] = _ApiClient["default"].convertToType(data['results'], [_OCRResult["default"]]);
        }
        if (data.hasOwnProperty('error')) {
          obj['error'] = _OCRError["default"].constructFromObject(data['error']);
        }
      }
      return obj;
    }
    ...
    value: function validateJSON(data) {
      ...
      if (data['results']) {
        ...
        try {
          for (_iterator.s(); !(_step = _iterator.n()).done;) {
            ...
            _OCRResult["default"].validateJSON(item);
          }
        } catch (err) {
          _iterator.e(err);
        } finally {
      ...
      if (data['error']) {
        // data not null
        _OCRError["default"].validateJSON(data['error']);
      }
      return true;
    }
  }]);
...
var _default = exports["default"] = OCRResponse;