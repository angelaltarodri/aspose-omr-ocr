...
var _OCRSettingsRecognizeImage = _interopRequireDefault(require("./OCRSettingsRecognizeImage"));
 ...
 * @version 5.0
 */
var OCRRecognizeImageBody = /*#__PURE__*/function () {
  /**
   ...
   */
  function OCRRecognizeImageBody(image, settings) {
    _classCallCheck(this, OCRRecognizeImageBody);
   ...
   */
  _createClass(OCRRecognizeImageBody, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('settings')) {
          obj['settings'] = _OCRSettingsRecognizeImage["default"].constructFromObject(data['settings']);
        }
      }
      return obj;
    }
    ...
    value: function validateJSON(data) {
      ...
      var _iterator = _createForOfIteratorHelper(OCRRecognizeImageBody.RequiredProperties),
        _step;
      try {
      ...
      if (data['settings']) {
        // data not null
        _OCRSettingsRecognizeImage["default"].validateJSON(data['settings']);
      }
      return true;
    }
  }]);
  return OCRRecognizeImageBody;
}();
...
var _default = exports["default"] = OCRRecognizeImageBody;