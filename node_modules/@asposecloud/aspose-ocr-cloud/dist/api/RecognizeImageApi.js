...
* @version 5.0
*/
var RecognizeImageApi = exports["default"] = /*#__PURE__*/function () {
  /**
  ...
  */
  function RecognizeImageApi(apiClient) {
    _classCallCheck(this, RecognizeImageApi);
   ...
   */
  _createClass(RecognizeImageApi, [{
    key: "cancelRecognizeImage",
    value: function cancelRecognizeImage(id, callback) {
      var postBody = null;
      ...
      var accepts = [];
      var returnType = null;
      return this.apiClient.callApi('/v5.0/ocr/RecognizeImage', 'DELETE', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null, callback);
    }
    ...
    key: "getRecognizeImage",
    value: function getRecognizeImage(id, callback) {
      var postBody = null;
      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
      ...
      return this.apiClient.callApi('/v5.0/ocr/RecognizeImage', 'GET', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null, callback);
    }
    ...
    key: "postRecognizeImage",
    value: function postRecognizeImage(oCRRecognizeImageBody, callback) {
      ...
      return this.apiClient.callApi('/v5.0/ocr/RecognizeImage', 'POST', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null, callback);
    }
  }]);
  return RecognizeImageApi;
}();